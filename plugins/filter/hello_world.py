"""A hello-world filter plugin in sshedmake_namespace_03.myrhdh_03."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_03 Myrhdh_03
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_03.myrhdh_03.hello_world }}"
"""
